...
class AdditiveAttentionLayer(Layer):
  ...
  def call(self, inputs):
    ...
    # print(K.int_shape(in_seq))
    # print(K.int_shape(out_vec))
    ...
    def cal_prob(out):
      ...
      # print(K.int_shape(W_as))

		  ##
      out = K.dot(out,self.Ua)
      # print(K.int_shape(out))

      temp = K.repeat(out,n=in_seq_shape[1])
      # print(in_seq_shape[1])
      # print(K.int_shape(temp))
      out = K.reshape(temp,(in_seq_shape[0]*in_seq_shape[1],-1))
      # print(K.int_shape(out))

      energy = K.reshape(K.dot(K.tanh(W_as+out),self.Va),(in_seq_shape[0],-1))
      print(K.int_shape(energy))
